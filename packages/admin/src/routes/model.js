...
module.exports = [
  {
    ...
    handler: async request => {
      ...
      console.info('the model description', description.children)
  ...
  },
  {
    ...
    handler: async (request, h) => {
      ...
      const description = Joi.describe(schema)
      console.info('model description', description.children)
      const keys = Object.keys(description.children)
      console.info('keys', keys)
      console.info('dataitmes', dataItems)
      const data = {
  ...
  },
  {
    ...
    handler: async (request, h) => {
      ...
      const description = Joi.describe(schema)
      console.info('model description in new', description.children)
      const keys = Object.keys(description.children)
      console.info('keys', keys)
      const data = {
        appName: request.params.appName,
  ...
  },
  {
    ...
    handler: async (request, h) => {
      console.info('the post', request.payload)
      const app = request.APPS_SETTINGS.filter(
        app => app.APP_ID === request.params.appName
      )[0]
      const model = app.MODELS.filter(model => {
