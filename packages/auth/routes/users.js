...
module.exports = [
    ...
    options: {
      ...
      response: {
        schema: Validation.object({
          data: Validation.array().items(User.schema),
          items: Validation.object({
            limit: Validation.number(),
            begin: Validation.number(),
            end: Validation.number(),
            total: Validation.number(),
          }),
          pages: Validation.object({
            current: Validation.number(),
            limit: Validation.number(),
            prev: Validation.number(),
            hasPrev: Validation.boolean(),
            next: Validation.number(),
            hasNext: Validation.boolean(),
            total: Validation.number(),
          }),
        }),
  ...
  },
  {
    ...
    options: {
      ...
      validate: {
        params: {
          id: Validation.string().invalid('000000000000000000000000'),
        },
        payload: {
          isActive: Validation.boolean().required(),
          username: Validation.string()
            .token()
            .lowercase()
            .required(),
