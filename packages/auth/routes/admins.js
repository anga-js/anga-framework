...
module.exports = [
  {
    ...
    handler: async function(request, h) {
      ...
      return Admin.pagedFind(query, page, limit, options)
    },
  },
  {
    method: 'POST',
  ...
  },
  {
    ...
    options: {
      ...
      validate: {
        params: {
          id: Validation.string().invalid('111111111111111111111111'),
        },
        payload: {
          name: Validation.object({
            first: Validation.string().required(),
            middle: Validation.string().allow(''),
            last: Validation.string().required(),
          }).required(),
        },
      },
      pre: [Preware.requireAdminGroup('root')],
  ...
  },
  {
    ...
    options: {
      ...
      validate: {
        ...
        payload: {
          groups: Validation.object().required(),
        },
      },
      pre: [Preware.requireAdminGroup('root')],
    },
  ...
  },
  {
    ...
    options: {
      tags: ['api', 'admins'],
      description:
        "Update an admin account's custom permissions by ID. [Root Scope]",
      ...
      validate: {
        ...
        payload: {
          permissions: Validation.object().required(),
        },
      },
      pre: [Preware.requireAdminGroup('root')],
    },
